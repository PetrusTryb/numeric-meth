function [M,N,P,R,x_coarse,y_coarse,F_coarse,x_fine,y_fine,F_fine] = zadanie5()
    P = 40; % liczba unikalnych współrzędnych x punktów dla których będzie obliczana interpolacja
	R = 40; % liczba unikalnych współrzędnych y punktów dla których będzie obliczana interpolacja
	M = 31; % liczba węzłów interpolacji wzdłuż osi X (stopień wielomianu zmiennej x: M-1)
	N = 31; % liczba węzłów interpolacji wzdłuż osi Y (stopień wielomianu zmiennej y: N-1)
